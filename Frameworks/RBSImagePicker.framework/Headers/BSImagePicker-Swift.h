...
@interface BSImagePickerController (SWIFT_EXTENSION(BSImagePicker))
...
@interface BSImagePickerController (SWIFT_EXTENSION(BSImagePicker)) <UIAdaptivePresentationControllerDelegate>
